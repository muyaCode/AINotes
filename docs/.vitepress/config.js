...
export default {
  ...
  title: "牡涯AI工具使用笔记", // 浏览器标签标题
  description: "AI工具使用笔记",
  base: '/AINotes/', // url默认前缀
  ...
  themeConfig: {
    ...
    // 编辑
    editLink: {
      pattern: 'https://github.com/muyaCode/AINotes/edit/main/docs/:path',
      text: '在 GitHub 上编辑此页'
    },
