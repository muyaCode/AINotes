...
![赛博朋克猫咪](./assets/0aaa3893e81d4d78b56d41ccb7db208ctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/0239a1eca2ad444da2d1da06d42d5210tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

根据你要生成的图片风格（比如：动漫、风景），挑选合适的模型查看，前面那个文生图的例子，使用的就是这个 `Deliberate` 模型，直接点击 "Download Latest" 即可下载该模型文件。

![img](./assets/a18aa06e91474da19af8cd217d0b6eaetplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/4ab9f11797164f329b8844da82e204c0tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

放置好模型文件之后，需要重启一下 `stable-diffusion-webui`（执行 `webui-user.bat`）才能识别到。

![img](./assets/84397776eb28476f928d6c9bfcfc1e41tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

这些模型文件一般会附带一组效果图，点击任意一张，就可以看到生成该效果图的一些参数配置：

![img](./assets/173697a92bc74fdd8db0cc923b3ece30tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/5abe6c44e5ee4ac995d700dd3b18284btplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/a0e2eda7f5ab4714b749ca90260c8799tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
