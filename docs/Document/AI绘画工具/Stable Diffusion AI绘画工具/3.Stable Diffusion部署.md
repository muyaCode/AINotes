...
![img](./assets/v2-b157d72e97e6dfc08489a2f0c23979f1_720w.webp)
...
![img](./assets/v2-695c8ca254fa6856c8e3d8a6a530d2db_720w.webp)
...
![image.png](./assets/297ad0e3c52c44e18ea5d23826d0c41ctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/81d586d7aeac4a638b430f89a39eb10etplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/a4765e3b177c4e999a3f1becab8a1f46tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/5866442a218f4ac8a54fe2b293e6629etplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/73bbbc2e939a4cd08e36e8144c42c02ctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/032bfd063bc84870a4a57df3384f3fc2tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/44d2f05cf9574d069574cd10cdf4c422tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

下载好模型后, 需要将模型文件放到 `stable-diffusion-webui/models/Stable-diffusion` 目录下

![image](./assets/1087279493064d6981c9ca44d0c36009tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/2ada8561cca6458e90d3a057eaefc56etplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

如果执行上面命令, 抛出错误了则需要修改项目根目录下的 `webui-user.sh` 文件: 该文件默认 `第十三行` 是被注释掉的, 我们需要修改这一行内容

![image](./assets/9c68b2b663054c608cff10e45467c9eatplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/16fca336c3a14205a7d413e487b7fcfftplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/ef9102da517542058cfa8626d59f8aa9tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

下面我们就可以通过上面的地址, 在浏览器访问 `Stable Diffusion` `WEB UI` 界面

![image](./assets/918cc4140844474c9ca1eb64e43baa7btplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

### 六、测试

下面我们尝试在界面上输入 `咒语` 生成图片, 如下截图在输入框中输入关键词 `home`, 然后点击 `Generate` 开始绘画

![image](./assets/0c26c27e69e147e1b6abb349453891d7tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

这里我们可以观察控制台, 就能够看到, 如下进度条, 这就说明系统正在生成图片

![image](./assets/3afac0f12d1841f683a490af55c8f70ftplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

这里需要等待一会(机器配置好坏决定等待时长), 最终会在右边生成一张图(当然图片的质量肯定是一般般的, 因为我们的咒语还是太简单了)

![image](./assets/4348c311ee7e42f1bb4e97063fcee455tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

这里我们还可以看下, 终端进度条, 也以显示 `100%`

![image](./assets/06db1e708ff2477f99ca7f92ddad99f4tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

> 最后补充下: 如果出现如下报错, 请参考上一章节, 通过修改项目根目录下的 `webui-user.sh` 文件, 可修改该问题

![image](./assets/ae48ccde905848db943969a5b5753dbftplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/beca9c4340e544db8f3a02bfe657c734tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/c18ed9d6616d49a28eb64941c9c067betplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

安装完成后, 我们还需要, 重新加载下 `UI`, 这里直接点击页面底部的 `Reload UI` 即可

![image](./assets/383f7ddc9cb248259f1d4c97996f8015tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/4459267623dc4dcf86099054df710b1btplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

选择完后, `保存配置` 并 `重新加载 UI`

![image](./assets/4133c811a2934a1694699826db8ae81dtplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

最后可以看下最终汉化后的效果

![image](./assets/8bcf8b46fc2f47989d6c68539f4e785atplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/2537e46071c446daa580a19524b0b5fatplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

这里我选择 [toonyou](https://civitai.com/models/30240/toonyou) 模型, 并进行了下载

![image](./assets/6c0716506b574dd192dcd731f02a4439tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

同上文, 这里我们需要将下载后的模型复制到 `stable-diffusion-webui/models/Stable-diffusion` 目录下

![image](./assets/94ebed1ee4fa4f69ba336a4e5e38a7e2tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

最后的最后, 我们需要重新加载下 `UI`

![image](./assets/de48be10ecce4aaa9856708debcaa648tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

加载完成后, 就可以在模型选择一栏, 看到我们下载好的模型了

![image](./assets/a497053c76914d55a2dbfd584b621697tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image](./assets/2c2ab559a0d24cf9a691f099249c9dfctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![页面地址：https://click.aliyun.com/m/1000373164/](./assets/27c37f2509fa453b9c5832e8efa1d17ctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![页面地址：https://click.aliyun.com/m/1000373164/](./assets/26641d0900034b6790a74c55158342f7tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/396f291473fc4ab0adf45912ddd29c98tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/d8384a2ffde44f8a80b1dfb4110754a3tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/a3dd82e935114ff98a93884abd7e57e1tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/91379da9e28d45e2b8c483ae0f9f5d5ctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/d94ca6527af644bf97965cf06f8811b0tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/908347c3a68643d8968fa210a1adb25btplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

![img](./assets/18881b21b25d4337bc4531e8559cd125tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/6b082996f09a4ae9ace0754d57ce26cbtplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

点击上图中的「创建」按钮之后，会弹出「创建服务」的对话框。

其他配置都不需要动，我们只需要设置一下端口映射关系即可：我们通过7860这个端口提供给大家访问。

![img](./assets/e6d807a059ba4e359f9c222d1dcbd99btplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

以上这些配置都完成以后，我们点击创建，系统就会自动提交并开始部署应用，**过程就是这么简单**！

![img](./assets/f343c4bee7ae476c9050cc71f3b22799tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

点击上方的「查看应用详情」后，我们也可以到控制台里去追踪应用的具体部署情况。等Pod的状态变为Running时，应用就已经成功上线了！

![img](./assets/1ac5e30472a443108a65fc56c8456038tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/42f38bf33a024b9c9a6289ffdf40b9f3tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

其对应有一个「外部端点」，即：一个可以访问Stable Diffusion AI绘画的公网IP。

我们直接点击，就可以打开浏览器，访问到Stable Diffusion的Web UI页面。

![img](./assets/de5020056a2a4a148d72018c1f97bc34tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

此时我们在该页面中输入提示词和参数，就可以开始AI绘画的创作了。

![img](./assets/2e09f69b95ba431ba1396c34649930bctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/9feee05cd1e74876bca2adb782af1f92tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/1010f22002da40c7a8bb742a0715e250tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](./assets/cb899c8c0cd1d4debc5675c28f04aaa795adf8ad.png@1256w_732h_!web-article-pic.webp)

- 地域：选择离你最近的地点，不选默认也行，预装镜像：选择Windows sever 2019中文版，点击立即购买付款后

![img](./assets/49a767358b60c71294e0cb3abec8fc7f915c642d.png@1256w_1628h_!web-article-pic.webp)

- 付款购买完成之后（大概5分钟后），我们点击右上角的“控制台”进入腾讯云总览首页，在“我的资源”当中点击“云服务器”即可进入服务器界面

![img](./assets/34157366dd77d5047778ec6dfdde21e0bd92a0b8.png@1256w_626h_!web-article-pic.webp)

- 这里插一嘴，默认购买的服务器硬盘是100G的，服务器系统直接占用了25G，也就是还剩下75G硬盘，通过我多年的经验，这个硬盘是不够的，建议将系统盘增加至200G，花费17.5元左右。

![img](./assets/f7041dcae9f52a351c3aac7af46740c3f558fe2a.png@1256w_812h_!web-article-pic.webp)

- 调整目标硬盘大小点击下一步付款就行。

![img](./assets/7eddaac9520baf786ce4a73787fae0844ddcdcbf.png@1256w_950h_!web-article-pic.webp)

#### 2.2 登录服务器

想要登录服务器获取服务器IP地址、用户名和密码，初始密码在顶部的站内信（小信封），点开即可看到，复制好密码后，点击右侧的登录按钮进入登录界面

![img](./assets/e9a62534ae48c3068a266ffaaa33343768981658.png@1256w_476h_!web-article-pic.webp)
...
![img](./assets/9b16168b77c097a95eb1fd5fa4ba6f485d4ddd38.png@1256w_1548h_!web-article-pic.webp)

- 这样就能直接进入到服务器的桌面了

![img](./assets/0aaf812b1be4e651f78c2c13b05c5e4e965202f3.png@1256w_614h_!web-article-pic.webp)

#### 2.3 安装显卡驱动

- 注意了，初始状态下，服务器是没有特斯拉显卡驱动的，我们需要打开服务器自带浏览器，访问 NVIDIA 驱动下载 <http://985.so/mfz54> 官网 找到Tesla-T4的驱动，下载对应的驱动进行安装

![img](./assets/f704b2e922d77401e582459a957fe363fb03a614.png@1256w_752h_!web-article-pic.webp)

- 默认安装完成之后，点击这个地址 C:\Program Files\NVIDIA Corporation\NVSMI，确认已经存在以下文件，进行下一步

![img](./assets/d37df95653b27bfc1984ca23b0074f51802cfd7a.png@1256w_452h_!web-article-pic.webp)

- 右键“此电脑”选择属性，

![img](./assets/a4ab14af223616859628b94cbab34cff863a894d.png@1256w_1140h_!web-article-pic.webp)

- 点击系统高级系统设置

![img](./assets/d21c5edd82feb73cc052088bafff813509041fd8.png@1256w_900h_!web-article-pic.webp)

- 点开环境变量

![img](./assets/ac0a4cccc02ce652ce21a7dc033e442d9a6432af.png@1256w_1764h_!web-article-pic.webp)

- 将地址C:\Program Files\NVIDIA Corporation\NVSMI新建至path的环境变量当中，点击确定

![img](./assets/002a71dbe4a89cf4957a34de04a8e04e6e0ae394.png@1256w_640h_!web-article-pic.webp)

- 开始菜单当中打开命令提示符，

![img](./assets/3953e3933abf5364c90004cfb6565ea95e7b0c25.png@1256w_810h_!web-article-pic.webp)

- 输入nvidia-smi 看到以下界面表示驱动程序安装成功，

![img](./assets/5c56016f9c8b724ff2a97111be8e33dde51ee518.png@1256w_810h_!web-article-pic.webp)
...
![img](./assets/84108efef5a641247740592e7635364acf223101.png@1256w_786h_!web-article-pic.webp)
...
![img](./assets/108883d14ad6dcdc506c5558a5ad90675f3bb206.png@!web-article-pic.webp)

- 打开一键启动后

![img](./assets/7e3b4ae16206aaa017a3c9f084478926400014fe.png@1256w_814h_!web-article-pic.webp)

- 当你看到这个界面的时候就可以开始你的出AI之旅了，到此为止服务器配置基本完成。

![img](./assets/30a2713ead152200e15ce86aaf2567c99c27f6c6.png@1256w_704h_!web-article-pic.webp)
...
![img](./assets/dae97b3bb55870cd53ad2cf32bc8b5b001ab82c5.png@1256w_728h_!web-article-pic.webp)

- 推荐其他的必选插件
- 中英文对照界面插件  <https://gitcode.net/overbill1683/stable-diffusion-webui-localization-zh_Hans>
- 最牛提示词插件 <https://gitcode.net/ranting8323/sd-webui-prompt-all-in-one>

![img](./assets/2c18ff6fe566ad5127b5f73fcb3cea2b9a107013.png@1256w_502h_!web-article-pic.webp)
...
![img](./assets/bdd5223b128880cfcf1a0391e0c066f874503656.png@1256w_730h_!web-article-pic.webp)

- 3.3如何实现多人使用服务器
- 一键启动之前，一定要在启动之前将这两个按钮打开，如果已经启动了，将黑色界面的控制台关掉重新配置打开。

![img](./assets/6a35b0d183f524df92ba668671f108a9ed351459.png@1256w_736h_!web-article-pic.webp)

- 启动之后就能得到这样的地址，将地址分享给你的朋友，用浏览器打开即可在多台电脑上实现云端出图

![img](./assets/5a216910102e2d58d926ad78a4e7b1b8d7f09e06.png@1256w_786h_!web-article-pic.webp)
